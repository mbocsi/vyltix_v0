...
export default async function Navbar() {
  ...
  return (
    <nav className="fixed top-0 h-16 w-full flex flex-row gap-4 justify-between items-center px-24 bg-white bg-opacity-50 dark:bg-zinc-950 dark:bg-opacity-60 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-900 z-10">
      <Link href="/">
